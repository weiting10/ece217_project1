...
void request_to_visualization_msgs_marker_array( const std::shared_ptr<rclcpp::Node>& node, const std::shared_ptr< project1::srv::PlanningQuery::Request >& request, visualization_msgs::msg::MarkerArray& markerArray ){
...
int main( int argc, char* argv[]){
  ...
  std::shared_ptr< project1::srv::PlanningQuery::Request > request = std::make_shared< project1::srv::PlanningQuery::Request>();
